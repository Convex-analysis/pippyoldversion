"""
EdgePipe pipeline runtime utilities.

This module mirrors the minimal runtime helpers used by EdgePipe so the
corresponding functions live inside the EdgePipe folder.
"""
